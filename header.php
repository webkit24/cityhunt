...
<script>
  ...
  ga('create', 'UA-72520704-1', 'auto');
  ga('send', 'pageview');

</script>
<meta name="google-site-verification" content="-MDsYT0qr9bk8JdbicK58o3EzC2bB6OUkvzlPgk-1is" />
...
<script>
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyDK_s_2fT0TlFL4CdxXCGa2fxgADX2BhKs",
    authDomain: "cityhunt-156410.firebaseapp.com",
    databaseURL: "https://cityhunt-156410.firebaseio.com",
    storageBucket: "cityhunt-156410.appspot.com",
    messagingSenderId: "832270378707"
  };
